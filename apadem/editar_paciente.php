...
<div class="container my-5" style="max-width: 800px;">
    <div class="card p-4 mb-4 contenedor-blanco-titulo shadow-sm">
        ...
        <p class="subtitulos">Modifique los campos necesarios.</p>
    </div>
    ...
    <form action="editar_paciente.php?id=<?php echo $id; ?>" method="POST" autocomplete="off">
        ...
        <div class="card p-4 mb-4 border-secondary-subtle shadow-sm">
            <h5 class="encabezado-seccion-interna mb-4 fw-bold text-dark border-bottom pb-2">Datos del Paciente</h5>
        ...
        <div class="card p-4 mb-4 border-secondary-subtle shadow-sm">
            <h5 class="encabezado-seccion-interna mb-4 fw-bold text-dark border-bottom pb-2">Datos del Responsable / Tutor</h5>
        ...
        <div class="d-flex gap-2 justify-content-end">
            ...
            <button type="submit" class="btn btn-apadem px-4" style="border-radius: 8px;">Guardar Cambios</button>
        </div>
    </form>
</div>
