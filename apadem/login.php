...
// variable vacía donde se guardará un mensaje de error
$error = "";
        ...
        <div class="col-12 col-sm-8 col-md-4"> 
            ...
            <div class="card p-4 rounded-0 border-secondary-subtle">
                ...
                <form method="POST" action="login.php" autocomplete="off">
                    ...
                    <button type="submit" name="acceso_admin" class="btn btn-primary w-100 py-2 btn-apadem rounded-0">Iniciar</button>
                </form>
            </div>
        </div>
    </div>
